...
create table signuptwo(form_no varchar (30), religion varchar (30), category varchar (30), income varchar(30), education varchar (30), occupation varchar (60), pan varchar (30),aadhaar varchar(60), senoircitizen varchar(30), existing_account varchar(30));
